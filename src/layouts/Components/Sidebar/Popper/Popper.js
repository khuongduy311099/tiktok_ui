        ...
        <div className={cx('popper-wrapper')} tabIndex="-1">
            <div className={cx('popper-inner')}>
                ...
                <p className={cx('nickname')}>
                    <strong>Dog</strong>
                    <FontAwesomeIcon className={cx('icon-official')} icon={faCheckCircle} />
                </p>
                <p className={cx('name')}>Dog.......</p>
                <div className={cx('info')}>
                    <div className={cx('follow')}>
                        <strong>4M</strong>
                        <div className={cx('text-info')}>Followers</div>
                    </div>
                    <div className={cx('likes')}>
                        <strong>140M</strong>
                        <div className={cx('text-info')}>Likes</div>
                    </div>
                </div>
            </div>
        </div>
